...
class Header extends Component {
      ...
      <div className={ classes.root }>
        <div className={ classes.headerV2 }>
          <div className={ classes.icon }>
            <img
              alt=""
              src={ require('../../assets/SAFE-256x256.png') }
              height={ '40px' }
              onClick={ () => { this.nav('') } }
            />
            <Typography variant={ 'h3'} className={ classes.name } onClick={ () => { this.nav('') } }>yieldfarming.insure</Typography>
          </div>
  ...
  nav = (screen) => {
    if(screen === 'cover') {
      window.open("https://yieldfarming.insure", "_blank")
      return
    }
